      ...
      <div className="bg-black1 rounded-2xl p-16 text-white1 text-[14px] font-medium border border-white-15">
        <div className={`flex flex-col md:flex-row justify-between mt-4`}>
          <div className='flex items-center mb-16 self-stretch'>
            <h1 className="text-[20px] leading-[1.2] mr-4">{isSpot ? 'Spot' : 'Futures'} Market Activity</h1>
        ...
        />
        <div className={`h-280 md:h-[calc(100vh-193px)] text-[12px] md:text-[14px] overflow-y-auto ${!activity.length ? 'flex justify-center items-center' : ''}`}>
